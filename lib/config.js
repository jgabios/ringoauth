...
exports.oauthConfig = {
    google: {
        ...
        redirectUri: '/googlecallback.sjs',
        loginUri: '/logingoogle.sjs',
    ...
    twitter: {
        ...
        redirectUri: '/twittercallback.sjs',
        loginUri: '/logintwitter.sjs'
    },
    facebook: {
        ...
        redirectUri: '/facebookcallback.sjs',
        loginUri: '/loginfacebook.sjs'
    },
}
